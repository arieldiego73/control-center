...
import HideBtnDeptStyle from "./hide_button_department/HideButtonDepartment.module.css";
      ...
      >
		<div style={{ justifyContent: "flex-end", display: "flex", padding:'1%' }}>
		  {!isHidden ? (
			...
			<div className={HideBtnDeptStyle.hideButton}>
			  <div
				style={{
				  flexDirection: "row",
				  display: "flex",
			  ...
			  >
				...
				<FormControl>
				  ...
				  <TextField
					...
					className={HideBtnDeptStyle.textField}
					InputProps={{
					  startAdornment: (
						<InputAdornment position="start">
						  <SearchIcon />
