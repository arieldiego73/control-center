...
import HideBtnEmpStatusStyle from "./hide_button_employee_status/HideButtonEmployeeStatus.module.css";
      ...
      >
		<div style={{ justifyContent: "flex-end", display: "flex", padding:'1%' }}>
		  {!isHidden ? (
			...
			<div className={HideBtnEmpStatusStyle.hideButton}>
			  <div
				style={{
				  flexDirection: "row",
				  display: "flex",
			  ...
			  >
				...
				<FormControl>
				  ...
				  <TextField
					...
					className={HideBtnEmpStatusStyle.textField}
					InputProps={{
					  startAdornment: (
						<InputAdornment position="start">
						  <SearchIcon />
