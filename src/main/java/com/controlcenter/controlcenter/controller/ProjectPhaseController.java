...
public class ProjectPhaseController {
    ...
    @PostMapping("/add")
    public String addProjectPhase(@RequestBody ProjectPhaseInput projectPhase){
        return projectPhaseService.addProjectPhase(projectPhase);
    }

    @PutMapping("/edit/{id}")
    public String editProjectPhase(@PathVariable String id, @RequestBody ProjectPhaseInput projectPhase){
